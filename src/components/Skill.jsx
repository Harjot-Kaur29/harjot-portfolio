    ...
    <div className={styles.flip_card}>
      <div className={styles.flip_card_inner}>
        ...
        <div className={styles.flip_card_back}>
          ...
          <p>Proficient in utilizing Python's built-in data structures like lists, tuples, dictionaries, and sets for efficient data organization and manipulation</p>
        </div>
      </div>
    </div>
    <div className={styles.flip_card}>
